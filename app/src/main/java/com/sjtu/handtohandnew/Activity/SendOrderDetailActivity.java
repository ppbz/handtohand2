...
public class SendOrderDetailActivity extends BaseActivity implements BaseInterface {

    private ListView list_SendOrderDetail;
    ...
    @ViewInject(R.id.sendOrderDetail)
    public static LinearLayout linearLayoutOrderDetail;

    @OnClick(R.id.sendOrderConnect)
    private void connect(View view){




        TextView textViewOrderSendName = findViewById(R.id.sendOrderSendName);
...
//        startActivity(intent);
        ...
        Intent intent = new Intent( SendOrderDetailActivity.this, ChatActivity.class );
    ...
    public void InitData() {
        list_SendOrderDetail = findViewById(R.id.sendOrderDetailListView);
        ...
        list_SendOrderDetail.setAdapter(commodityAdapter);
